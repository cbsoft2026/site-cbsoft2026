...
Caso queira usar o Docker Compose como alternativa à instalação manual, veja a seção [Docker Compose](#iniciando-o-projeto-com-docker).

Antes de começar, é necessário ter o [Node.js](https://nodejs.org/pt/download) instalado e criar um arquivo `.env` para configurar parâmetros do `sitemap.xml` e rotas das páginas. Veja o `.env.example` para as variáveis.
