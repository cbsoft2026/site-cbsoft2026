...
O participante deverá acessar o sistema ECOS e realizar sua inscrição, selecionando a opção de pagamento "Nota de empenho" ou "Faturamento". Uma vez solicitado o pagamento, o sistema fornecerá as informações necessárias que deverão constar na nota de empenho ou no pedido de faturamento.
...
A inscrição inclui apenas alimentação nos coffee breaks. O almoço é por conta de cada participante e, da mesma forma, o jantar do evento será por adesão.
