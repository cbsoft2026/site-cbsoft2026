...
| Notification of Acceptance | August 03, 2026 |
| Camera-Ready Submission | August 10, 2026 |
| Symposium Dates | From September 08 to 12, 2026 |
...
*Data Papers:* We welcome submissions centered on datasets, benchmarks, curated repositories, and data resources of interest to the SBCARS community. Submissions should describe the context, creation process, structure, limitations, and potential reuse of the data. Page limit: up to 4 pages (+2 for references). Authors of accepted Data Papers must make their artifacts publicly accessible. Recommended data repositories include: [Zenodo](https://zenodo.org/) and [Figshare](https://figshare.com/). GitHub is not a proper data repository.


#### Reviewing Process

Evaluation criteria include rigor, novelty, relevance, presentation, verifiability/transparency, and openness for replication. We encourage authors to make their artifacts open and accessible, although it is not mandatory.

All submissions will undergo a rigorous double-blind peer review process. The papers submitted must not reveal the authors' identities in any way.

* Authors should leave out their names and affiliations from the body of their submission.
...
* Authors should avoid providing URLs to author-revealing sites (e.g., tools or datasets). Any supplemental sites should be fully anonymized. While open science is encouraged for all authors, visiting such sites should not be necessary to conduct reviews.
* Authors should anonymize author-revealing company names, while still providing general characteristics of the organizations involved to help readers understand the paper's context.

For fairness, all submitted papers must comply with the above instructions. Submissions that violate these instructions may be rejected without review at the discretion of the PC chairs.
...
* All submissions must be written in Portuguese or English and must adhere to the ACM two-column format (ACM_SigConf), available at this [link](https://www.acm.org/publications/proceedings-template). 
