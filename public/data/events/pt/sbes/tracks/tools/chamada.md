...
* Os artigos devem ter no máximo 6 (seis) páginas, incluindo figuras (em boa qualidade), tabelas, apêndices e agradecimentos, e até 1 (uma) página adicional para referências. Os artigos podem ser escritos em português ou inglês. Os artigos devem ser submetidos em Adobe Portable Document Format (PDF).
